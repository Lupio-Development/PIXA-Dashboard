  ...
  const mapData = [
          ...
          <div className="">
            <div className="d-flex">
              ...
              <div className="ms-3 text-start">
                <p
                  className="mb-0 text-white fw-normal"
                  ...
                  return (
                    <>
                      <span
                        ...
                        {att?.name} :-
                        <b
                          className="text-white fw-normal ms-1"
                          style={{ fontSize: "14px" }}
                        >
                          {att?.value}
                        </b>
...

    {
      ...
      Cell: ({ row }) => {
        return (
          <>
            <span className="fs-6 text-white fw-normal">{row?.purchasedTimeShippingCharges}$</span>
          </>
        );
      },
    },
    {
      ...
      Cell: ({ row }) => {
        return (
          <>
            <span className="fs-6 text-white fw-normal">
...

    {
      ...
      Cell: ({ row }) => {
        return (
          <>
            <b className="fs-6 text-white fw-normal">
                            ...
                            <table className="w-100 ms-4">
                              <tbody>
                                <tr className="text-start ">
                                  <td
                                    width="180px"
                                    className="py-3 text-profile text-white fw-normal"
                                  >
                                    Total Items
                                  </td>
                                  <td width="30px">:</td>
                                  <td className="text-capitalize text-start text-white fw-normal">
                              ...
                              <table className="w-100">
                                <tbody>
                                  <tr className="text-start ">
                                    ...
                                    >
                                      <b className="text-white fw-normal">Amount</b>
                                    </td>
                                    <td width="30px">:</td>
                                    <td className="text-capitalize text-start text-white fw-normal">
                                  ...
                                  <tr className="text-start">
                                    <td
                                      ...
                                      className="py-3 text-profile "
                                    >
                                      <b className="text-white fw-normal">Shipping Charge</b>
                                    </td>
                                    <td width="30px">:</td>
                                  ...
                                  <tr className="text-start ">
                                    <td
                                      width="180px"
                                      className=" text-profile text-white fw-normal"
                                    >
                                      <b className="text-white fw-normal">Total Amount</b>
                                    </td>
                                    <td width="30px">:</td>
                                    <td className="text-capitalize text-start">
                                      <b className="text-white fw-normal"> {orderDetail?.total} $</b>
                                    </td>
                                  </tr>
                                  <tr className="text-start ">
                                    <td
                                    ...
                                    >
                                      <b className="text-white fw-normal">Discount</b>
                                    </td>
                                    <td width="30px">:</td>
                                  ...
                                  <tr className="text-start ">
                                    <td
                                      ...
                                      className=" text-profile "
                                    >
                                      <b className="text-white fw-normal">Total</b>
                                    </td>
                                    <td width="30px">:</td>
                                    <td className="text-capitalize text-start">
                                      <b className="text-white fw-normal"> {orderDetail?.finalTotal} $</b>
                                    </td>
                                  </tr>
                                </tbody>
                              </table>
                    ...
                    <div className="card mt-3" style={{ borderRadius: "5px" }}>
                      <div className="card-header">
                        <div className="d-flex py-2">
                          <h5 className="card-title fw-bold flex-grow-1 mb-0 text-white">
                            <i className="bi bi-truck align-middle me-1 text-white" />{" "}
                            Logistics Details
                          </h5>
                    ...
                    <div className="card mt-4" style={{ borderRadius: "5px" }}>
                      <div className="card-header">
                        <h5 className="card-title fw-bold my-2">
                          <i className="bi bi-geo-alt align-middle me-1 fw-bold text-white" />{" "}
                      ...
                      <div className="card-body">
                        <ul className="list-unstyled vstack gap-2 fs-13 mb-0">
                          <li className="fw-bold fs-14 text-white">
                            {data?.shippingAddress?.name}
                          </li>
                          <li className="py-1 text-white fw-normal">
