                          ...
                          <div className="col-xl-3 col-md-6 col-12">
                            <FormControl sx={{ m: 1, width: 300 }}>
                              ...
                              <Select
                                ...
                                multiple
                                value={personNames[index]?.value || []}
                                onChange={(event) =>
                                  handlePersonNameChange(index, event.target.value, data?.name)
                                }
                                input={
                                  <OutlinedInput
                                ...
                                renderValue={(selected) => (
                                  ...
                                  >
                                    {Array.isArray(selected) ? (
                                      ...
                                      <Chip key={selected} label={selected} sx={{ color: "white" }} />
                                    )}
                                  </Box>
                                )}
                                MenuProps={MenuProps}
                                ...
                                {data?.value?.map((name) => (
                                  <MenuItem
                                    ...
                                    style={{
                                      ...getStyles(
                                        name,
                                        personNames && personNames[0] && Array.isArray(personNames[0].value)
                                          ? personNames[0].value[index] || []
                                          : [],
                                        theme
                                      ),
                                      color: "white", // Change MenuItem text color to white
                                    }}
                                  >
                                    {name}
                                  </MenuItem>
                            ...
                            {error.personNames && error.personNames.length > 0 && (
                              <div className="ml-2 mt-1">
                                <div className="pl-1 text__left">
                                  <span className="errorMessage" style={{ color: "white" }}>
                                    {error.personNames}
                                  </span>
                                </div>
                              </div>
                    ...
                    <div className="col-12 d-flex justify-content-end">
                      ...
                      {!mongoId ? (
                        ...
                        <>
                          <Button
                            btnName={`Update`}
                            btnColor={`btnBlackPrime text-dark ms-2`}
                            style={{ borderRadius: "5px", width: "80px" }}
                            onClick={(e) => handleSubmit(e)}
                          />
                        </>
