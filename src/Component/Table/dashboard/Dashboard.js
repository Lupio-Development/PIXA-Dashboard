...
const Dashboard = (props) => {
  ...
  console.log('sDate3', sDate3);
  console.log('eDate3', eDate3);
    ...
    datasets: [
      {
        ...
        data: dataUser,
        fill: false,
        backgroundColor: "rgba(215, 219, 26, 0.24)",
        borderColor: "#D7DB1A",
        lineTension: 0.5,
        pointBorderWidth: 2,
      },
  ...
  const mapData = [
    ...
    },
    {
      ...
      Cell: ({ row }) => (
        <>
          <span className="py-4 text-white fw-normal">{row?.total}$</span>
        </>
      ),
    },
    ...
    },
    {
      ...
      Cell: ({ row }) => (
        ...
        >
          ...
          >
            <b className="fw-normal text-capitalize" style={{ color: "#FFF" }}>
              ...
              >
                ...
                >
                  <div className="sellerMenuHeader mt-2">
                    ...
                    >
                      <li
                        className={`pb-0 ${type === "Product" && "activeLineDash "
                          }`}
                      >
                        <a
                          className={`profileDash mb-0 ${type === "Product" && "activeLineDashFont "
                            }`}
                          onClick={() => {
                            setType("Product");
                          }}
                      ...
                      <li
                        className={`pb-0 ${type === "Popular" && "activeLineDash "
                          }`}
                      >
                        <a
                          className={`profileDash mb-0 ${type === "Popular" && "activeLineDashFont "
                            }`}
                          onClick={() => {
                            setType("Popular");
                          }}
                      ...
                      <li
                        className={`pb-0 ${type === "Seller" && "activeLineDash "
                          }`}
                      >
                        <a
                          className={`profileDash mb-0 ${type === "Seller" && "activeLineDashFont "
                            }`}
                          onClick={() => {
                            setType("Seller");
                          }}
                      ...
                      <li
                        className={`pb-0 ${type === "Customer" && "activeLineDash "
                          }`}
                      >
                        <a
                          className={`profileDash mb-0 ${type === "Customer" && "activeLineDashFont "
                            }`}
                          onClick={() => {
                            setType("Customer");
                          }}
                  ...
                  <div className="d-flex align-items-center justify-content-between my-2">
                    ...
                    <div>
                      ...
                      >
                        <input
                          type="text"
                          className="form-control text-center card my-1 white-placeholder"
              ...
              <div className="card">
                <div className="card-body py-0">
                  <div className="d-flex align-items-center justify-content-between my-2">
                    <div className="d-flex align-iems-center">
                      <i className="bi bi-circle-fill text-era"></i>
                      <h6 className="ms-2 text-white">Admin Revenue</h6>
                    </div>
                    <div>
                      <style jsx>{`
                        .white-placeholder::placeholder {
