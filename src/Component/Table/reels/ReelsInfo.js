                    ...
                    <div className="col-xl-4 col-md-6">
                      <div className="post-body">
                        <div className="d-flex">
                          ...
                          <div className="ms-3">
                            <h4 className="mb-1" style={{ fontSize: "15px" , color : "#FFF" }}>
                            ...
                            <span className="" style={{ fontSize: "13px" , color : "#FFF"}}>
                              {" "}
                      ...
                      <div className="mt-4 mt-xl-0">
                        <div className="row">
                          <div className="col-md-6 col-12">
                            <h3
                              className={`mb-3 fw-bold mb-0 fs-5 text-white`}
                              style={{ color: "#b93160" }}
                            >
                              Product Detail
                            </h3>
                                      ...
                                      <div className="d-flex">
                                        ...
                                        <div className="ms-3">
                                          <h4
                                            ...
                                            style={{ fontSize: "17px" , color : "#B5B5B5" }}
                                          >
                        ...
                        {type === "Comment" && (
                          <div className="likeContent">
                            <p className="text-center p-5 mb-0 text-white">
                              No data found
                            </p>
                          </div>
                        )}
