...
const Transition = (props) => {
  ...
  const mapData = [
...

    {
      ...
      Cell: ({ row }) => {
        ...
        return (
          <>
            <div className="">
              <p className="mb-0 fw-normal text-white">{date[0]}</p>
              <p className="mb-0 fw-normal text-white">{date[1]}</p>
            </div>
          </>
        );
      },
    ...
    },
    {
      ...
      Cell: ({ row }) => (
        <div className="">
          <p className="mb-0 text-white font-normal">{row?.sellerPendingAmount} $</p>
        </div>
      ),
    },
    {
      ...
      Cell: ({ row }) => (
        <div className="">
          <p className="mb-0 text-white font-normal">{row.adminCommission} $</p>
        </div>
      ),
    },
