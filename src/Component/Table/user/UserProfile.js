                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <div className=" d-flex justify-content-center  ">
                            <div className="text-center top-spacer">
                              ...
                              <h5 className="mt-3 fs-5 fw-normal text-white">
                              ...
                              <div className="col-6 boxEnd">
                                <div className="d-flex">
                                  ...
                                  <div className="ms-2">
                                    ...
                                    <p className="text-p mb-0 font-weight-regular text-white">
                                      Followers
                                    </p>
                                  </div>
                                </div>
                        ...
                        <div className="userAbout">
                          <h4 className="ms-2 text-white fs-5 pt-3">Details</h4>
                        </div>
                        <div className="userDetail m-3">
                          <ul>
                            ...
                            <li className="pb-4">
                              ...
                              <span className="mx-2 text-white">:</span>
                              <span className="text-white">{userProfile?.gender}</span>
                            </li>
                            <li className="pb-4">
                              <span className="mb-0 text-h6 font-weight-regular">
                                Birth Date
