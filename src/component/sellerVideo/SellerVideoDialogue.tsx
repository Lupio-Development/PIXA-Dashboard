...
const SellerVideoDialogue: React.FC = () => {
      ...
      >
        <Box sx={style} className="create-channel-model">
          ...
          <div className="row mt-3">
            <video
              controls
              src={dialogueData?.videoUrl || dialogueData?.video?.videoUrl}
              width={0}
              height={350}
          ...
          <div className="col-12 mt-2">
            ...
            <Typography variant="body1" style={{ fontSize: "14px", color: "#000", marginLeft: "10px", fontWeight: "500", marginTop: "15px" }}>
                ...
                <div >
                  ...
                  {!showFullCaption && (
                    <span
                      ...
                      style={{ color: "#1F3C88", cursor: "pointer", fontWeight: "bold" }}
                    >
                      Read More
                    </span>
                  )}
...
export default SellerVideoDialogue;
