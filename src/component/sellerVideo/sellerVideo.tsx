...
import { allVideoOfSeller, deleteVideoOfSeller } from "@/store/sellerVideoSlice";
...
const sellerVideo: any = (props) => {
    const { startDate, endDate } = props;
    const router = useRouter();
    const { realSellerVideo, totalRealVideo } = useSelector(
    ...
    const handleDeleteVideo = (row: any) => {
        ...
        data
            .then((logouts: any) => {
                const yes = logouts;
                if (yes) {
                    dispatch(deleteVideoOfSeller(row?._id));
                }
            })
...
sellerVideo.getLayout = function getLayout(page) {
