...
const AppSetting = () => {
  ...
  const [accountSide, setAccountSide] = useState<string>("");
  const [videoEditingLicenseKey, setVideoEditingLicenseKey] = useState<string>("");
  const [authToken, setAuthToken] = useState<string>("");
  const [verifySide, setVerifySid] = useState<string>("");
  ...
  useEffect(() => {
    ...
    setAccountSide(settingData?.accountSid);
    setVideoEditingLicenseKey(settingData?.videoEditingLicenseKey);
    setAuthToken(settingData?.authToken);
    setVerifySid(settingData?.verifySid);
  ...
  const handleSubmit = () => {
    ...
    const settingDataAd = {
      ...
      accountSid: accountSide,
      authToken: authToken,
      verifySid: verifySide,
      videoEditingLicenseKey: videoEditingLicenseKey,
    };
              ...
              <div className="mb-4">
                ...
                <div className="withdrawal-box payment-box mt-4">
                  <div className="row">
                    ...
                    >
                      Image and Video Moderation Setting
                    </h6>
            ...
            <div className="col-6">
              <div className="mb-4">
                ...
                <div className="withdrawal-box payment-box mt-4">
                  ...
                  <div className="row withdrawal-input"></div>
                  <div className="row mt-2">
                    <div className="col-6">
                      <Input
                        label={"Account Sid"}
                    ...
                    <div className="col-6 mt-3 border-top">
                      <div className="mt-3">
                        <Input
                          label={"Verify Sid"}
                          name={"VerifySid"}
                          ...
                          placeholder={""}
                          onChange={(e) => {
                            setVerifySid(e.target.value);
                          }}
                        />
                      </div>
                    </div>
                    <div className="border-top col-6 mt-4"></div>
                  </div>
                </div>

                <div className="withdrawal-box payment-box mt-4">
                  <h6>Video Editing Setting</h6>

                  <div className="row withdrawal-input"></div>
                  <div className="row mt-2">
                    <div className="col-12">
                      <Input
                        label={"Video Editing Licence Key"}
                        name={"VideoEditingLicenseKey"}
                        type={"text"}
                        value={videoEditingLicenseKey || ""}
                        placeholder={""}
                        onChange={(e) => {
                          setVideoEditingLicenseKey(e.target.value);
                        }}
                      />
                    </div>
