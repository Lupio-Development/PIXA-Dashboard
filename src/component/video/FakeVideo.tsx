...
const FakeVideo: React.FC<FakeVideoProps> = (props) => {
  ...
  const videoTable = [
    ...
    },
    {
      ...
      Cell: ({ row }: { row: any }) => (
        <>
          <div
            className="text-capitalize userText fw-bold d-flex justify-content-center align-items-center"
            style={{
              cursor: "pointer",
            }}
    ...
    },
    {
      ...
      Cell: ({ row }: { row: any }) => (
        <div className="action-button">
          <Button
            btnIcon={
              <img src={EditIcon?.src} alt="EditIcon" width={25} height={25} />
            }
            onClick={() => {
  ...
  return (
    <div>
      <div className="user-table mb-3 border-0 pt-0">
