...
const AdminEarnings = (props) => {
    ...
    const { adminEarnings , totalEarning} = useSelector((state: RootStore) => state.adminEarning);
    ...
    const earningTable = [
        ...
        },
        {
            ...
            Cell: ({ row, index }) => (
                ...
                >
                    <img src={row?.image || male.src} width="40px" height="40px" style={{marginRight : "10px"}} />
