...
import { AddItem } from "@/component/productRequest/DeclineRequest/AddItem";
import { UpdateItem } from "@/component/productRequest/DeclineRequest/UpdateItem";
...
MainPage2.getLayout = function getLayout(page) {
