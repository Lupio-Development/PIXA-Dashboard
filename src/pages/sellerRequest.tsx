...
import PendingSellerRequest from "@/component/sellerRequest/PendingSellerRequest";
import AcceptedSellerRequest from "@/component/sellerRequest/AcceptedSellerRequest";
import DeclinedSellerRequest from "@/component/sellerRequest/DeclinedSelllerRequest";

const selllerRequest = () => {
      ...
      <div className="userPage pt-0">
        ...
        >
          ...
          {multiButtonSelect == "Accepted" && (
            <AcceptedSellerRequest endDate={endDateData} startDate={startDateData} />
          )}
          {multiButtonSelect == "Declined" && (
            <DeclinedSellerRequest endDate={endDateData} startDate={startDateData} />
          )}
...
selllerRequest.getLayout = function getLayout(page) {
  return <RootLayout>{page}</RootLayout>;
};
export default selllerRequest;
