...
import PendingSupportRequest from "@/component/supportRequest/PendingSupportRequest";
import AcceptedSupportRequest from "@/component/supportRequest/AcceptedSupportRequest";
    ...
    <>
      <div className="userPage pt-0">
        ...
        >
          ...
          {multiButtonSelect == "Solved" && (
            <AcceptedSupportRequest endDate={endDateData} startDate={startDateData} />
          )}
