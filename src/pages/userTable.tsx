...
const ManageUser = () => {
  ...
  const [multiButtonSelect, setMultiButtonSelect] = useState<string>("Real User");
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      try {
        const parsed = storedSubTab ? JSON.parse(storedSubTab) : "Real User";
        setMultiButtonSelect(parsed);
      } catch (e) {
        console.error("Error parsing sub-tab from localStorage:", e);
        setMultiButtonSelect("Real User");
      }
    }
  }, []);
