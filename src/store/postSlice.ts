...
export const uploadDeleteImage = createAsyncThunk(
  "admin/file/removeUploadContent",
  async (payload: AllPostPayload) => {
    return axios.delete(`admin/file/removeUploadContent`, {
      data: payload,
    });
  }
);
...
export const allHashTag : any = createAsyncThunk(
