...
import sellerRequestSlice from "./sellerRequestSlice";
import bankSlice from "./bankSlice";
import productRequestSlice from "./productRequestSlice";
import productSlice from "./productSlice";
import sellerVideoSlice from "./sellerVideoSlice";
import sellerVideo from "@/pages/sellerVideoTable";
...
export function makeStore() {
  return configureStore({
    reducer: {
      ...
      seller: sellerSlice,
      sellerRequest: sellerRequestSlice,
      productRequest: productRequestSlice,
      product: productSlice,
      sellerVideo: sellerVideoSlice
    },
  });
}
